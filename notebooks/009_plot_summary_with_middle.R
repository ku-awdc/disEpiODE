...
#'
#'
output_summary <- if (file.exists("output/007_output_summary.csv")) {
  readr::read_csv("output/007_output_summary.csv", lazy = FALSE)
} else {
  readr::read_csv("output/007_summary.csv", lazy = FALSE)
}
#'
output_summary <-
  output_summary %>%
