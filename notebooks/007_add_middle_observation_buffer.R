...
ggsave(
  ...
  filename =
    glue("~/GitHub/disEpiODE/output/007_grid_at_tau_plots/",
...
report_row %>%
  readr::write_excel_csv(
    append = TRUE,
    col_names = !file.exists("~/GitHub/disEpiODE/output/007_summary.csv"),
    "~/GitHub/disEpiODE/output/007_summary.csv")
#'
#'
#'
readr::write_rds(
  model_output,
  str_c(
    "~/GitHub/disEpiODE/output/007_model_output_",
